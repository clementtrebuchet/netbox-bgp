...
class BGPSessionView(generic.ObjectView):
    ...
    def get_extra_context(self, request, instance):
        ...
        import_policies_table = tables.RoutingPolicyTable(
            import_policies_qs, orderable=False
        )
        export_policies_table = tables.RoutingPolicyTable(
            export_policies_qs, orderable=False
        )
...
class PasswordView(generic.ObjectView):
    queryset = Password.objects.all()
    template_name = "netbox_bgp/password.html"


class PasswordDeleteView(generic.ObjectDeleteView):
    queryset = Password.objects.all()
    default_return_url = "plugins:netbox_bgp:password_list"
